...
bool EditorUIModule::Init()
{
    ...
    colors[ImGuiCol_WindowBg]             = ImVec4(0.13f, 0.13f, 0.15f, 1.0f);
    colors[ImGuiCol_ChildBg]              = ImVec4(0.10f, 0.10f, 0.12f, 1.0f);
    colors[ImGuiCol_PopupBg]              = ImVec4(0.16f, 0.16f, 0.18f, 1.0f);
    ...
    colors[ImGuiCol_Header]               = ImVec4(0.25f, 0.30f, 0.40f, 1.0f);
    colors[ImGuiCol_HeaderHovered]        = ImVec4(0.35f, 0.40f, 0.55f, 1.0f);
    colors[ImGuiCol_HeaderActive]         = ImVec4(0.45f, 0.50f, 0.70f, 1.0f);

    colors[ImGuiCol_Button]               = ImVec4(0.23f, 0.23f, 0.27f, 1.0f);
    colors[ImGuiCol_ButtonHovered]        = ImVec4(0.30f, 0.35f, 0.50f, 1.0f);
    colors[ImGuiCol_ButtonActive]         = ImVec4(0.40f, 0.45f, 0.70f, 1.0f);

    colors[ImGuiCol_FrameBg]              = ImVec4(0.20f, 0.20f, 0.25f, 1.0f);
    colors[ImGuiCol_FrameBgHovered]       = ImVec4(0.30f, 0.30f, 0.38f, 1.0f);
    colors[ImGuiCol_FrameBgActive]        = ImVec4(0.35f, 0.35f, 0.45f, 1.0f);

    colors[ImGuiCol_Tab]                  = ImVec4(0.18f, 0.18f, 0.20f, 1.0f);
    colors[ImGuiCol_TabHovered]           = ImVec4(0.35f, 0.35f, 0.45f, 1.0f);
    colors[ImGuiCol_TabActive]            = ImVec4(0.25f, 0.25f, 0.32f, 1.0f);
    colors[ImGuiCol_TabUnfocused]         = ImVec4(0.18f, 0.18f, 0.20f, 1.0f);
    colors[ImGuiCol_TabUnfocusedActive]   = ImVec4(0.25f, 0.25f, 0.32f, 1.0f);

    colors[ImGuiCol_TitleBg]              = ImVec4(0.10f, 0.10f, 0.12f, 1.0f);
    colors[ImGuiCol_TitleBgActive]        = ImVec4(0.16f, 0.16f, 0.20f, 1.0f);
    colors[ImGuiCol_TitleBgCollapsed]     = ImVec4(0.10f, 0.10f, 0.10f, 0.7f);
    ...
    colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.45f, 0.45f, 0.50f, 1.0f);
    colors[ImGuiCol_ScrollbarGrabActive]  = ImVec4(0.55f, 0.55f, 0.60f, 1.0f);
    ...
    colors[ImGuiCol_ResizeGrip]           = ImVec4(0.30f, 0.30f, 0.35f, 1.0f);
    colors[ImGuiCol_ResizeGripHovered]    = ImVec4(0.45f, 0.45f, 0.55f, 1.0f);
    colors[ImGuiCol_ResizeGripActive]     = ImVec4(0.55f, 0.55f, 0.65f, 1.0f);
