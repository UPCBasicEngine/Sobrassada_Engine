...
class CuChulainn : public Character
{
  ...
  private:
    ...
    std::string attackVfxHorizontalName = "AttackVfxH";
    std::string attackVfxVerticalName   = "AttackVfxV";
    GameObject* meleeVfxObject          = nullptr;
    GameObject* meleeTrailObject        = nullptr;
    GameObject* attackVfxHorizontal     = nullptr;
    GameObject* attackVfxVertical       = nullptr;
